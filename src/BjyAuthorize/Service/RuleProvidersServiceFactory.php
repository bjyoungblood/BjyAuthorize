 ...
 */
class RuleProvidersServiceFactory implements FactoryInterface
{
    /**
     * {@inheritDoc}
     *
     * @return \BjyAuthorize\Provider\Rule\ProviderInterface[]
     */
    public function createService(ServiceLocatorInterface $serviceLocator)
    {
        ...
        foreach ($config['rule_providers'] as $providerName => $providerConfig) {
